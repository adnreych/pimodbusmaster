...
public class SwaggerConfig {
	...
	private ApiInfo apiEndPointsInfo() {
		return new ApiInfoBuilder()
			.title("pimodbusmaster")
			.description("Универсальный конфигуратор для устройств Modbus")
			.version("1.0.0")
			.build();
    }
    ...
    public Docket api() {
    	return new Docket(DocumentationType.SWAGGER_2)
    		.select()
    		.apis(RequestHandlerSelectors.basePackage("net.lockoil.pimodbusmaster.controller"))
    		.build()
